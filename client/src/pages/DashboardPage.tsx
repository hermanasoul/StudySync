    ...
    <div className="dashboard-page">
      ...
      <div className="page-with-header">
        <div className="dashboard-container animate-fade-in-up">
          ...
          {/* Основная сетка дашборда – теперь 3 колонки */}
          <div className="dashboard-grid">
            {levelProgress && (
              <div className="dashboard-section compact">
                <div className="section-header">
                <h2 style={{ fontSize: '20px' }}>⭐ Мой уровень</h2>
            ...
            {/* Быстрая статистика перемещена в общую сетку */}
          ...
          {/* Предметы остаются отдельно под сеткой */}
